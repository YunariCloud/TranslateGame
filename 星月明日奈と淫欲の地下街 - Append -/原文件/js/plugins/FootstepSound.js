...
(function() {
    ...
    var footStepJson = {
        ...
        always     : {
            interval: 3,
            walk1   : {name: 'se_walk02_l', volume: 8, pitch: 50, pan: 0},
            walk2   : {name: 'se_walk02_l', volume: 8, pitch: 50, pan: 0},
            dash1   : {name: 'se_walk02_l', volume: 8, pitch: 50, pan: 0},
            dash2   : {name: 'se_walk02_l', volume: 8, pitch: 50, pan: 0},
        },
        // 梯子属性通過時の足音
        ladder     : {
            interval: 3,
        ...
        boat       : {
            interval: 4,
            walk1   : {name: '', volume: 8, pitch: 50, pan: 0},
            walk2   : {name: '', volume: 8, pitch: 50, pan: 0},
        },
        // 大型船乗船時の足音
        ship       : {
            interval: 4,
