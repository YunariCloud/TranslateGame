...
(function() {
	...
	Window_InformationMapName.prototype.refresh = function() {
        ...
        /* this.drawText('ソース内編集,上下254幅', this.standardPadding() + 5, this.standardPadding() +40, this._width - 20, Align_MapName);
        this.drawText('スキルポイント：$gameVariables.value(19)', this.standardPadding() + 5, this.standardPadding() +30, this._width - 20, Align_MapName); */

        this.drawText(" 経過日数：" + $gameVariables.value(20) + "日", this.standardPadding() + 5, this.standardPadding() +105, this._width - 20, 'left');
        this.drawText(" chapter：" + $gameVariables.value(18), this.standardPadding() + 5, this.standardPadding() +145, this._width - 20, 'left');
        //this.drawText(" ----------------", this.standardPadding() + 5, this.standardPadding() +82, this._width - 20, 'left');
        this.drawText(" スキルP：" + $gameActors.actor(1).stsSp(), this.standardPadding() + 5, this.standardPadding() +20, this._width - 20, 'left');
        this.drawText(" 淫欲結晶：" + $gameVariables.value(101) + "個", this.standardPadding() + 5, this.standardPadding() +60, this._width - 20, 'left');
	};
