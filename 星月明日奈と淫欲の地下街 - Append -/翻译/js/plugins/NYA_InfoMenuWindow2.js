...
(function() {
	...
	Window_InformationMapName.prototype.refresh = function() {
        ...
        this.drawText(" 经过天数：" + $gameVariables.value(20) + "日", this.standardPadding() + 5, this.standardPadding() +105, this._width - 20, 'left');
        this.drawText(" 章节：" + $gameVariables.value(18), this.standardPadding() + 5, this.standardPadding() +145, this._width - 20, 'left');
        //this.drawText(" ----------------", this.standardPadding() + 5, this.standardPadding() +82, this._width - 20, 'left');
        this.drawText(" 技能点：" + $gameActors.actor(1).stsSp(), this.standardPadding() + 5, this.standardPadding() +20, this._width - 20, 'left');
        this.drawText(" 淫欲结晶：" + $gameVariables.value(101) + "个", this.standardPadding() + 5, this.standardPadding() +60, this._width - 20, 'left');
	};
